...
> 自動依據 YouTube 影片畫質（4K 2160p, 2K 1440p, 1080p, 720p 等）精確調整播放器視窗尺寸，零留白無縫貼合。
...
**YouTube Auto Resizer & Quality Controller** 是一款專為提升 YouTube 觀影體驗而打造的 Chrome / Brave 瀏覽器擴充功能 (Manifest V3)。
